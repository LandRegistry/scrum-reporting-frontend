...
class ProjectForm(Form):
    ...
    project_description = TextField('Project Description', [validators.Length(min=1, max=200)], widget=TextArea())
...
class SprintForm(Form):
    ...
    sprint_deliverables = TextField('Sprint Deliverables', [validators.Length(min=0, max=500)], widget=TextArea())
    ...
    sprint_challenges = TextField('Sprint Challenges', [validators.Length(min=0, max=500)], widget=TextArea())
    sprint_issues = TextField('Sprint Issues', [validators.Length(min=0, max=500)], widget=TextArea())
